...
%% Initialize the environment for Periodic motion 1 
...
% z_total = simulation(30, Xstar, t, z); % simulate 30 steps      DOES NOT FOLLOW DOWN
 z_total = simulation(50, Xstar, t, z); % simulate 50 steps      FOLLOWS DOWN
% z_total = simulation(200, Xstar, t, z); % simulate 200 steps      FOLLOWS DOWN
...
title('Phase plane in q1,q1d - Periodic motion 1');
...
title('Phase plane in q2,q2d - Periodic motion 1');
xlabel('X: Displacement');
ylabel('Y: Velocity');
hold off;
...
%% Analisys of the stability
 ...
 if stability == 0
     ...
     disp('The periodic motion is UNSTABLE for Periodic motion 1');
     
 elseif stability == 1
     
     disp('The periodic motion is STABLE for Periodic motion 1');
